...
class ConfigurationView(ctk.CTkFrame):
    def __init__(self, parent, state_obj, bootstrap_callback):
        ...
        ctk.CTkLabel(form_frame, text="Target Target Corporate Profile Name:", font=("Arial", 14)).pack(pady=(20,5), padx=40, anchor="w")
        ...
        ctk.CTkLabel(form_frame, text="Security Operations Control Center Target Email Notification Target Address:", font=("Arial", 14)).pack(pady=(20,5), padx=40, anchor="w")
        ...
        ctk.CTkLabel(form_frame, text="Dynamic Platform Threat Feed Refresh Harvesting Metric Collection Interval Interval Scaling Rate:", font=("Arial", 14)).pack(pady=(20,5), padx=40, anchor="w")
        ...
        ctk.CTkButton(self, text="Initialize Native Active Monitoring Network Engine", font=("Arial", 16, "bold"), fg_color="#10b981", hover_color="#059669", height=50, command=self.execute_provisioning).pack(pady=40)
